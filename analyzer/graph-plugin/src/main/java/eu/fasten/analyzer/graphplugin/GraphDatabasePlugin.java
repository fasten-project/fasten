...
public class GraphDatabasePlugin extends Plugin {
    ...
    public static class GraphDBExtension implements KafkaPlugin, GraphDBConnector {
        ...
        public void consume(String record) {
            ...
            if (gidGraph.getProduct().contains(Constants.coordinatePartsJoin)) {
                groupId = gidGraph.getProduct().split(Constants.coordinatePartsJoin)[0];
                artifactId = gidGraph.getProduct().split(Constants.coordinatePartsJoin)[1];
            } else {
