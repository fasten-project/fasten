...
public class DependencyApiTest {
    ...
    public void getPackageDependenciesTest() {
        ...
        Mockito.when(service.getPackageDependencies(packageName, version, offset, limit, null)).thenReturn(response);
        var result = api.getPackageDependencies(packageName, version, offset, limit, null);
        assertEquals(response, result);
        Mockito.verify(service).getPackageDependencies(packageName, version, offset, limit, null);
    }
}
