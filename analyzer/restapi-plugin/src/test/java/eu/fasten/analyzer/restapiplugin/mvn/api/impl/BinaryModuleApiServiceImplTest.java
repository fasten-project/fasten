...
public class BinaryModuleApiServiceImplTest {
    ...
    void getPackageBinaryModulesTest() {
        ...
        var result = service.getPackageBinaryModules(packageName, version, offset, limit, null);
    ...
    void getBinaryModuleMetadataTest() {
        ...
        var expected = new ResponseEntity<>(response, HttpStatus.OK);
        var result = service.getBinaryModuleMetadata(packageName, version, module, null);
        assertEquals(expected, result);

        Mockito.when(kbDao.getBinaryModuleMetadata(packageName, version, module)).thenReturn(null);
        result = service.getBinaryModuleMetadata(packageName, version, module, null);
    ...
    void getBinaryModuleFilesTest() {
        ...
        var expected = new ResponseEntity<>(response, HttpStatus.OK);
        var result = service.getBinaryModuleFiles(packageName, version, module, offset, limit, null);
        assertEquals(expected, result);
