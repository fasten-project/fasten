...
public class FileApiTest {
    ...
    public void getPackageFilesTest() {
        ...
        Mockito.when(service.getPackageFiles(packageName, version, offset, limit, null)).thenReturn(response);
        var result = api.getPackageFiles(packageName, version, offset, limit, null);
        assertEquals(response, result);
        Mockito.verify(service).getPackageFiles(packageName, version, offset, limit, null);
    }
}
