...
public final class JavaToScalaConverter {
    ...
    public static Function0<JarInputStream> asScalaFunction0File(final String defaultFile) {
        return new AbstractFunction0<>() {

            @Override
            public JarInputStream apply() {
                try {
                    return new JarInputStream(new FileInputStream(new File(defaultFile)));
                } catch (IOException e) {
                    e.printStackTrace();
                }
                return null;
    ...
    public static AbstractFunction2<Object, Throwable, BoxedUnit> asScalaFunction2Exception() {
        return new AbstractFunction2<>() {

            @Override public BoxedUnit apply(Object v1, Throwable v2) {
                return null;
            }
        };
    }
