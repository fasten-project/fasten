...
public class OPALPartialCallGraphConstructor {
     ...
     *
     * @param ocg call CPythonGraph constructor
     */
    ...
    /**
     * Creates RevisionCallGraph using OPAL call CPythonGraph generator for a given maven
    ...
    /**
     * Creates a class hierarchy for the given call CPythonGraph's artifact with entries
    ...
    /**
     * Given a call CPythonGraph generated by OPAL and class hierarchy iterates over methods
     * declared in the package that call external methods and add them to externalCHA of
     * a call hierarchy. Build a CPythonGraph for both internal and external calls in parallel.
     *  @param ocg  call CPythonGraph from OPAL generator
