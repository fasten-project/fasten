...
public class KafkaProducerMonster {
    ...
    private static final String TOPIC = "callgraphs";
    private static final String BROKER = "localhost:30001,localhost:30002,localhost:30003";
        ...
        try {
            for (long index = time; index < time + graphNumber; index++) {
                final ProducerRecord<Long, String> record =
                        new ProducerRecord<>(TOPIC, index, callGraph + index);
