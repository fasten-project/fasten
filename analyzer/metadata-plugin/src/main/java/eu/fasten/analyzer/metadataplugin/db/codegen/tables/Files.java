...
public class Files extends TableImpl<FilesRecord> {
    ...
    private static final long serialVersionUID = 1670693;
     ...
     */
    public final TableField<FilesRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(DSL.field("nextval('files_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>public.files.package_id</code>.
     */
    public final TableField<FilesRecord, Long> PACKAGE_ID = createField(DSL.name("package_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.files.namespaces</code>.
     */
    public final TableField<FilesRecord, String> NAMESPACES = createField(DSL.name("namespaces"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.files.sha256</code>.
     */
    public final TableField<FilesRecord, byte[]> SHA256 = createField(DSL.name("sha256"), org.jooq.impl.SQLDataType.BLOB, this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.FILES_PKEY);
    }
    ...
    public List<ForeignKey<FilesRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<FilesRecord, ?>>asList(Keys.FILES__FILES_PACKAGE_ID_FKEY);
    }

    public PackageVersions packageVersions() {
        return new PackageVersions(this, Keys.FILES__FILES_PACKAGE_ID_FKEY);
    }
