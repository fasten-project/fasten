...
public class Files extends TableImpl<FilesRecord> {
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.FILES_PACKAGE_VERSION_ID);
    }
    ...
    public List<UniqueKey<FilesRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.UNIQUE_VERSION_PATH);
    }

    @Override
    public List<ForeignKey<FilesRecord, ?>> getReferences() {
        return Arrays.asList(Keys.FILES__FILES_PACKAGE_VERSION_ID_FKEY);
    }
