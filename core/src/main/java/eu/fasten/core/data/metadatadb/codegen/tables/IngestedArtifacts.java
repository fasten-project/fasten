...
public class IngestedArtifacts extends TableImpl<IngestedArtifactsRecord> {
     ...
     */
    public final TableField<IngestedArtifactsRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>public.ingested_artifacts.package_name</code>.
     */
    public final TableField<IngestedArtifactsRecord, String> PACKAGE_NAME = createField(DSL.name("package_name"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.ingested_artifacts.version</code>.
     */
    public final TableField<IngestedArtifactsRecord, String> VERSION = createField(DSL.name("version"), SQLDataType.CLOB.nullable(false), this, "");
    ...
    public Identity<IngestedArtifactsRecord, Long> getIdentity() {
        return (Identity<IngestedArtifactsRecord, Long>) super.getIdentity();
    }
