...
public class DependenciesRecord extends TableRecordImpl<DependenciesRecord> implements Record7<Long, Long, String[], JSONB, String[], String[], Long> {

    private static final long serialVersionUID = -260363880;
    ...
    @Override
    public Row7<Long, Long, String[], JSONB, String[], String[], Long> valuesRow() {
    ...
    @Override
    public DependenciesRecord value6(String... value) {
        setDependencyType(value);
        return this;
    }

    @Override
    public DependenciesRecord value7(Long value) {
        setAlternativeGroup(value);
        return this;
    }

    @Override
    public DependenciesRecord values(Long value1, Long value2, String[] value3, JSONB value4, String[] value5, String[] value6, Long value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DependenciesRecord(Long packageVersionId, Long dependencyId, String[] versionRange, JSONB metadata, String[] architecture, String[] dependencyType, Long alternativeGroup) {
        super(Dependencies.DEPENDENCIES);
        ...
        set(3, metadata);
        set(4, architecture);
        set(5, dependencyType);
        set(6, alternativeGroup);
    }
}
