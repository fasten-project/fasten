...
public class VulnerabilitiesPurls extends TableImpl<VulnerabilitiesPurlsRecord> {
    ...
    private static final long serialVersionUID = -1707745999;
     ...
     */
    public final TableField<VulnerabilitiesPurlsRecord, Long> VULNERABILITY_ID = createField(DSL.name("vulnerability_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.vulnerabilities_purls.forge</code>.
     */
    public final TableField<VulnerabilitiesPurlsRecord, String> FORGE = createField(DSL.name("forge"), org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>public.vulnerabilities_purls.package_name</code>.
     */
    public final TableField<VulnerabilitiesPurlsRecord, String> PACKAGE_NAME = createField(DSL.name("package_name"), org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>public.vulnerabilities_purls.package_version</code>.
     */
    public final TableField<VulnerabilitiesPurlsRecord, String> PACKAGE_VERSION = createField(DSL.name("package_version"), org.jooq.impl.SQLDataType.CLOB, this, "");
    ...
    /**
     * Create an aliased <code>public.vulnerabilities_purls</code> table reference
     */
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.VULNERABILITIES_PURLS_VULNERABILITY_ID);
    }

    @Override
    public List<ForeignKey<VulnerabilitiesPurlsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<VulnerabilitiesPurlsRecord, ?>>asList(Keys.VULNERABILITIES_PURLS__VULNERABILITIES_PURLS_VULNERABILITY_ID_FKEY);
    }

    public Vulnerabilities vulnerabilities() {
        return new Vulnerabilities(this, Keys.VULNERABILITIES_PURLS__VULNERABILITIES_PURLS_VULNERABILITY_ID_FKEY);
    }
