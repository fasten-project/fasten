...
public class EncryptIv extends AbstractRoutine<byte[]> {
    ...
    private static final long serialVersionUID = 2106461309;
     ...
     */
    public static final Parameter<byte[]> _3 = Internal.createParameter("_3", org.jooq.impl.SQLDataType.BLOB, false, true);
     ...
     */
    public EncryptIv() {
        super("encrypt_iv", Public.PUBLIC, org.jooq.impl.SQLDataType.BLOB);
