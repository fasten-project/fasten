...
public class VulnerabilitiesXCallables extends TableImpl<VulnerabilitiesXCallablesRecord> {
    ...
    private static final long serialVersionUID = -179767024;
     ...
     */
    public final TableField<VulnerabilitiesXCallablesRecord, Long> VULNERABILITY_ID = createField(DSL.name("vulnerability_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.vulnerabilities_x_callables.callable_id</code>.
     */
    public final TableField<VulnerabilitiesXCallablesRecord, Long> CALLABLE_ID = createField(DSL.name("callable_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
    ...
    public Vulnerabilities vulnerabilities() {
        return new Vulnerabilities(this, Keys.VULNERABILITIES_X_CALLABLES__VULNERABILITIES_X_CALLABLES_VULNERABILITY_ID_FKEY);
    }

    public Callables callables() {
        return new Callables(this, Keys.VULNERABILITIES_X_CALLABLES__VULNERABILITIES_X_CALLABLES_CALLABLE_ID_FKEY);
    }
