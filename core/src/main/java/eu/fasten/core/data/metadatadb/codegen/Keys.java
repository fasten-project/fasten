...
public class Keys {
    ...
    public static final UniqueKey<IngestedArtifactsRecord> INGESTED_ARTIFACTS_PKEY = Internal.createUniqueKey(IngestedArtifacts.INGESTED_ARTIFACTS, DSL.name("ingested_artifacts_pkey"), new TableField[] { IngestedArtifacts.INGESTED_ARTIFACTS.ID }, true);
    public static final UniqueKey<IngestedArtifactsRecord> UNIQUE_INGESTED_ARTIFACTS = Internal.createUniqueKey(IngestedArtifacts.INGESTED_ARTIFACTS, DSL.name("unique_ingested_artifacts"), new TableField[] { IngestedArtifacts.INGESTED_ARTIFACTS.PACKAGE_NAME, IngestedArtifacts.INGESTED_ARTIFACTS.VERSION }, true);
