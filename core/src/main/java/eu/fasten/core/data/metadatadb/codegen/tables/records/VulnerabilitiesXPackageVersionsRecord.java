...
public class VulnerabilitiesXPackageVersionsRecord extends TableRecordImpl<VulnerabilitiesXPackageVersionsRecord> implements Record2<String, Long> {
    ...
    @Override
    public VulnerabilitiesXPackageVersionsRecord value1(String value) {
    ...
    @Override
    public VulnerabilitiesXPackageVersionsRecord values(String value1, Long value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public VulnerabilitiesXPackageVersionsRecord(String vulnerabilityId, Long packageVersionId) {
        super(VulnerabilitiesXPackageVersions.VULNERABILITIES_X_PACKAGE_VERSIONS);
