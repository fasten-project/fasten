...
public class Dependencies extends TableImpl<DependenciesRecord> {
     ...
     */
    public final TableField<DependenciesRecord, Long> PACKAGE_VERSION_ID = createField(DSL.name("package_version_id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.dependencies.dependency_id</code>.
     */
    public final TableField<DependenciesRecord, Long> DEPENDENCY_ID = createField(DSL.name("dependency_id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.dependencies.version_range</code>.
     */
    public final TableField<DependenciesRecord, String[]> VERSION_RANGE = createField(DSL.name("version_range"), SQLDataType.CLOB.getArrayDataType(), this, "");

    /**
     * The column <code>public.dependencies.architecture</code>.
     */
    public final TableField<DependenciesRecord, String[]> ARCHITECTURE = createField(DSL.name("architecture"), SQLDataType.CLOB.getArrayDataType(), this, "");

    /**
     * The column <code>public.dependencies.dependency_type</code>.
     */
    public final TableField<DependenciesRecord, String[]> DEPENDENCY_TYPE = createField(DSL.name("dependency_type"), SQLDataType.CLOB.getArrayDataType(), this, "");

    /**
     * The column <code>public.dependencies.alternative_group</code>.
     */
    public final TableField<DependenciesRecord, Long> ALTERNATIVE_GROUP = createField(DSL.name("alternative_group"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>public.dependencies.metadata</code>.
     */
    public final TableField<DependenciesRecord, JSONB> METADATA = createField(DSL.name("metadata"), SQLDataType.JSONB, this, "");
    ...
    @Override
    public List<UniqueKey<DependenciesRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.UNIQUE_VERSION_DEPENDENCY_RANGE);
    }

    @Override
    public List<ForeignKey<DependenciesRecord, ?>> getReferences() {
        return Arrays.asList(Keys.DEPENDENCIES__DEPENDENCIES_PACKAGE_VERSION_ID_FKEY, Keys.DEPENDENCIES__DEPENDENCIES_DEPENDENCY_ID_FKEY);
    }
    ...
    public PackageVersions packageVersions() {
        if (_packageVersions == null)
            _packageVersions = new PackageVersions(this, Keys.DEPENDENCIES__DEPENDENCIES_PACKAGE_VERSION_ID_FKEY);
    ...
    public Packages packages() {
        if (_packages == null)
            _packages = new Packages(this, Keys.DEPENDENCIES__DEPENDENCIES_DEPENDENCY_ID_FKEY);
