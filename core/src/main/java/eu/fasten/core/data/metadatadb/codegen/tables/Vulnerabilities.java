...
public class Vulnerabilities extends TableImpl<VulnerabilitiesRecord> {
    ...
    private static final long serialVersionUID = -1493987421;
     ...
     */
    public final TableField<VulnerabilitiesRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('vulnerabilities_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>public.vulnerabilities.statement</code>.
     */
    public final TableField<VulnerabilitiesRecord, JSONB> STATEMENT = createField(DSL.name("statement"), org.jooq.impl.SQLDataType.JSONB, this, "");
    ...
    public Identity<VulnerabilitiesRecord, Long> getIdentity() {
        return Keys.IDENTITY_VULNERABILITIES;
    }
