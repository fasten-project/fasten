...
public class ModulesRecord extends UpdatableRecordImpl<ModulesRecord> implements Record5<Long, Long, String, Timestamp, JSONB> {

    private static final long serialVersionUID = 417965131;
    ...
    /**
     * Setter for <code>public.modules.namespace</code>.
     */
    ...
    /**
     * Getter for <code>public.modules.namespace</code>.
     */
    ...
    public Field<String> field3() {
        return Modules.MODULES.NAMESPACE;
    }
    ...
    @Override
    public ModulesRecord values(Long value1, Long value2, String value3, Timestamp value4, JSONB value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ModulesRecord(Long id, Long packageVersionId, String namespace, Timestamp createdAt, JSONB metadata) {
        super(Modules.MODULES);
