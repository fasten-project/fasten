...
public class ModulesRecord extends UpdatableRecordImpl<ModulesRecord> implements Record8<Long, Long, Long, Boolean, Access, Long[], Long[], JSONB> {
    ...
    @Override
    public Row8<Long, Long, Long, Boolean, Access, Long[], Long[], JSONB> valuesRow() {
    ...
    @Override
    public ModulesRecord values(Long value1, Long value2, Long value3, Boolean value4, Access value5, Long[] value6, Long[] value7, JSONB value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
