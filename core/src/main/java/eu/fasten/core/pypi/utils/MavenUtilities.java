...
/**
 * The helper utility class for working with pypi repositories and pom files.
 */
public class MavenUtilities {
     ...
     */
    public static String MAVEN_CENTRAL_REPO = "https://repo.pypi.apache.org/pypi2/";
    ...
    public static Optional<File> downloadPom(String groupId, String artifactId, String version) {
        List<String> pypiRepos = MavenUtilities.getRepos();
        return MavenUtilities.downloadPom(groupId, artifactId, version, pypiRepos);
    }

    /**
     * Download pom file of the given coordinate with a given set of pypi repositories.
     *
     * @param groupId    groupId of the artifact to find its dependencies
     * @param artifactId artifactId of the artifact to find its dependencies
     * @param version    version of the artifact to find its dependencies
     * @param pypiRepos the list of predefined pypi repositories
     * @return an optional pom file instance
     */
    public static Optional<File> downloadPom(String groupId, String artifactId, String version, List<String> pypiRepos) {
        for (var repo : pypiRepos) {
     ...
     *
     * @return list of urls of available pypi repositories
     */
    ...
    public static boolean pypiArtifactExists(String groupId, String artifactId, String version, String artifactRepo) {
