 ...
 *
 * <p>
 * All predicates are about a given callable (specified with its {@linkplain Callables#CALLABLES#ID
 ...
 * <li>the metadata associated with the module of the given callable
 * ({@link Modules#MODULES#METADATA});
 * <li>the metadata associated with the package version of the given callable
 * ({@link PackageVersions#PACKAGE_VERSIONS#METADATA}).
 * </ul>
 *
 * <p>
